...
class SimpleActionClientTurtle:
    ...
    def done_callback(self, status, result):
        ...
        result_new="("+str(result.final_x)+","+str(result.final_y)+","+str(result.final_theta)+")"
        goal_handle1 = action_client.send_goal("mqtt", "pub", action_client._config_mqtt_pub_topic, str(result_new))
        ...
        parameters = {"id":"Sheet1", "turtle_x":result.final_x,"turtle_y":result.final_y,"turtle_theta":result.final_theta} 

        URL = "https://script.google.com/macros/s/AKfycbwXzjtKrr7XGOKF5y7BiaVnSrwnqsd2Ot-AGsdzx127XPIz4PnP/exec"
...
def main():
    ...
    rospy.Subscriber('/ros_iot_bridge/mqtt/sub',msgMqttSub,call_back1)
    rospy.spin()
